...
pl.plot(data[1][slice], data[2][slice], "x", label ="32")
slice = np.isclose(data[0], 33)
pl.plot(data[1][slice], data[2][slice], "x", label ="33")
slice = np.isclose(data[0], 1024)
pl.plot(data[1][slice], data[2][slice], "x", label ="1024")
slice = np.isclose(data[0], 1025)
pl.plot(data[1][slice], data[2][slice], "x", label ="1025")
slice = np.isclose(data[0], 2048)
pl.plot(data[1][slice], data[2][slice], "x", label ="2048")
slice = np.isclose(data[0], 2049)
pl.plot(data[1][slice], data[2][slice], "x", label ="2049")
